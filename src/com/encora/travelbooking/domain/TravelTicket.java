...
//abstract to parent class, so you can only create from child
public abstract class TravelTicket implements Comparable<TravelTicket> {
    ...
    public TravelTicket(Long bookingRef,
                        String origin,
                        String destination,
                        BigDecimal price,
                        LocalDateTime departureTime,
                        LocalDateTime arrivalTime) throws InvalidTravelDurationException {
    ...
    public LocalDateTime getDepartureTime() {
        //System.out.println(departureTime.get(ChronoField.ALIGNED_WEEK_OF_YEAR));
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(bookingRef, that.bookingRef) && Objects.equals(origin, that.origin)
                && Objects.equals(destination, that.destination) && Objects.equals(price, that.price)
                && Objects.equals(departureTime, that.departureTime) && Objects.equals(arrivalTime, that.arrivalTime);
    }

...
//extends because child class, so you can add what you need in TrainTicket.
public class TrainTicket extends TravelTicket implements Comparable<TravelTicket> {
    ...
    public TrainTicket(Long bookingRef,
                       String origin,
                       String destination,
                       BigDecimal price,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(travelClass, that.travelClass) && Objects.equals(carriageNumber, that.carriageNumber)

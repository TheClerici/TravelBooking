...
//extends because child class, so you can add what you need in BusTicket.
public class BusTicket extends TravelTicket implements Comparable<TravelTicket> {
    ...
    public BusTicket(Long bookingRef,
                     String origin,
                     String destination,
                     BigDecimal price,
                     LocalDateTime departureTime,
                     LocalDateTime arrivalTime,
                     ArrayList<String> permittedProviders) throws InvalidTravelDurationException {
